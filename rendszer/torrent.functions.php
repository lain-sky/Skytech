...
function dict_check($d, $s) {
	...
	foreach ($a as $k) {
		...
		if (!isset($dd[$k]))
			die("Semmiylen tracker címet nem adtál meg a torrent fájlban!!");
		if (isset($t)) {
			if ($dd[$k]["type"] != $t)
...
/*
	...
	$data.='privatei1e6:source6:szicsuee';
*/

	$dataEleje=substr($data,0,(strlen($data)-2) );
	$minta="7:privatei1e6:source6:szicsuee";
	
	
	$data=$dataEleje .  $minta;
