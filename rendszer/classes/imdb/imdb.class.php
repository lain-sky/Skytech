<?php
 ...
 /* $Id: imdb.class.php 641 2014-01-22 21:09:28Z izzy $ */
  ...
  * @version $Revision: 641 $ $Date: 2014-01-22 22:09:28 +0100 (Mi, 22. Jan 2014) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 641 $');
    $this->setid($id);
  }
