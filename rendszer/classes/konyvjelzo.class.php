<?php 
if(!defined('SZINT1') || SZINT1!==666 ) die('Hozzáférés megtagadva');
...
class KonyvJelzo{
	...
	function setKonyvLista(){
		...
		$tomb=db::tomb();
		if(count($tomb)<1){
			return array( 0 => '<div class="bookmark">Egy árva könyvjelzõd sincs <img src="kinezet/smilies/smile1.gif" alt="" class="smiley" border="0"></div>' );
		}
		else{
			$kesz = array();
			$item='';
