...
<!--	<script type="text/javascript" src="scriptek/jobb.js"></script> -->
	...
	<script type="text/javascript" src="scriptek/jquery.cookie.pack.js"></script>
	
	
	
	<!--[if lte IE 6]>
		<link rel="stylesheet" type="text/css" href="kinezet/{if $ipanel.smink}{$ipanel.smink}{else}alap{/if}/ie_style.css" id="csslink"/>
	<![endif]-->
...
<body>
	<div id="main_container">
		<div id="logo">
			<script type="text/javascript">runFlash("/kinezet/szurke/header.swf",960,120,"banner","banner")</script>
		</div>
		<div id="menu_nav">
			{$menu_kek}
		</div>
