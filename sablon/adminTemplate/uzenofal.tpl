{$modulnev|section_open}
	{foreach from=$data item=cikk}
		<div>
			...
			<div class="right">
				<a href="{$lap_cime}?modul=uzenofal_del&id={$cikk.cid}" class="confirm pic" title="Bejegzés törlése">
					<img src="kinezet/{$ipanel.smink}/t_delete.png" alt="" class="inline" border="0">
				</a>
				&nbsp;&bull;&nbsp;
				<a href="{$lap_cime}?modul=uzenofal_mod&id={$cikk.cid}" class="pic" title="Bejegzés szerkesztése">
