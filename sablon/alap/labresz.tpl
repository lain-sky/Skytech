        ...
        {php}
                ...
                $ido=round((ora_allj-ora_indul)*1000,0);
                $this->assign('ido',$ido);
                ...
                @db::hardClose();
        {/php}
		<p><span class="small"><span class="highlight">Ez az oldal {$ido} ms alatt készült el, benne {$sql.num} SQL lekérdezés {$sql.time} ms alatt. Memóriahasználat: {$memo}</span></span></p>
</div>
